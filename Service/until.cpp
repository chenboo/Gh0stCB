...
DWORD GetProcessID(LPCTSTR lpProcessName)
{
	...
	{
		if (0 == _tcscmp(proInfo.szExeFile, lpProcessName))
		{
...
char *GetLogUser2K()
{
	...
	__try
	{
		...
		fResult = LookupAccountSidA(NULL, pTokenUser->User.Sid, lpUserName, &nNameLen,
...
bool SwitchInputDesktop()
{
	...
	if (strcmp(strInputDesktop, strCurrentDesktop) != 0)
	{
